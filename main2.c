...
/* Menu de gestion des stats */
void statistiquesMenu() {
    int choix;
    do {
        printf("\n=== STATISTIQUES ===\n");
        printf("1. Statistiques sur un intervalle de temps\n");
        printf("2. Menu de tri des consommations\n");
        printf("0. Retour\n");
        printf("Entrez votre choix: ");
        if (scanf("%d", &choix) != 1) {
            choix = 0;
